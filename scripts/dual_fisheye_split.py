...
class BagReader(Node):
    def __init__(self):
        ...
        bag_path = os.path.expanduser('/home/container_user/wheelchair2/src/records/back_og/rosbag2_2025_08_20-06_53_01_0.db3')
...
class DualFisheyeSplit(Node):
    ...
    def split_callback(self, dual_fisheye_msg):
        ...
        self.front_fisheye_pub.publish(self.bridge.cv2_to_imgmsg(front_img_full, "bgr8"))
        self.back_fisheye_pub.publish(self.bridge.cv2_to_imgmsg(back_img_full, "bgr8"))
